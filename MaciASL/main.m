...
void handle_exception(NSException *exception) {
    @try {
        ...
        NSRunAlertPanel(@"Uncaught Exception", @"An uncaught exception has occurred, and the program will now terminate. Please post the revealed file (may contain personal information), to %@", nil, nil, nil, @"http://github.com/devicemanager/bugtracker/issues");
